...
python transferClassifier.py --demography merged --logged_entry_name transferRobertaClassifier-mean-lastlayer-seed:1111-bs:32 --pooling_type mean --learning_rate 0.0001 > ../results/transferRobertaClassifier-mean-merged-lastlayer-seed:1111-bs:32.txt
...
python classifier.py --batch_size 32 --demography merged --model_name_or_path microsoft/deberta-v3-small --tokenizer_name_or_path microsoft/deberta-v3-base --logged_entry_name deberta-v3-small-seed:1111-bs:32 --learning_rate 0.0001 > ../results/deberta-v3-small-seed:1111-bs:32-merged.txt


python classifier.py --batch_size 32 --demography merged --model_name_or_path johngiorgi/declutr-small --tokenizer_name_or_path johngiorgi/declutr-small --seed 100 --logged_entry_name declutr-small-seed:100-bs:32  --learning_rate 0.0001 > ../results/declutr-small-seed:100-bs:32-merged.txt

python classifier.py --batch_size 32 --demography merged --model_name_or_path johngiorgi/declutr-small --tokenizer_name_or_path johngiorgi/declutr-small --seed 500 --logged_entry_name declutr-small-seed:500-bs:32  --learning_rate 0.0001 > ../results/declutr-small-seed:500-bs:32-merged.txt

python classifier.py --batch_size 32 --demography merged --model_name_or_path johngiorgi/declutr-small --tokenizer_name_or_path johngiorgi/declutr-small --seed 1000 --logged_entry_name declutr-small-seed:1000-bs:32  --learning_rate 0.0001 > ../results/declutr-small-seed:1000-bs:32-merged.txt

python classifier.py --batch_size 32 --demography merged --model_name_or_path johngiorgi/declutr-small --tokenizer_name_or_path johngiorgi/declutr-small --seed 5000 --logged_entry_name declutr-small-seed:5000-bs:32  --learning_rate 0.0001 > ../results/declutr-small-seed:5000-bs:32-merged.txt
