...
parser.add_argument('--model_name_or_path', type=str, default="distilbert-base-cased", help="Name of the model to be trained (can only be between distilbert-base-cased)")
parser.add_argument('--tokenizer_name_or_path', type=str, default="distilbert-base-cased", help="Name of the tokenizer to be used (can only be between distilbert-base-cased)")
parser.add_argument('--logged_entry_name', type=str, default="distilbert-base-cased-temp:0.05-seed:1111", help="Logged entry name visible on weights and biases")
...
parser.add_argument('--save_dir', type=str, default=os.path.join(os.getcwd(), "../models/text-classifier-baselines"), help="""Directory for models to be saved""")
...
directory = os.path.join(args.save_dir, "seed:" + str(args.seed), args.demography, args.model_name_or_path.split("/")[-1])
